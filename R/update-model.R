...
update_model <- function(model, code = NULL, gen_inits = NULL,
                         random_effects = NULL, fixed = NULL, report = NULL, select_data = NULL,
...
update_model.mb_model <- function(model, code = NULL, gen_inits = NULL,
  ...
  if (is.null(report)) report <- model$report
  ...
  model(x = code, gen_inits = gen_inits,
        random_effects = random_effects, fixed = fixed, report = report, select_data = select_data,
