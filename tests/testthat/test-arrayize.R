...
test_that("arrayize", {
  ...
  expect_error(arrayize(list$a, list["fac6"]), "factors must be at least of length 2")
  expect_error(arrayize(list$a, list[c("fac6","fac3")]), "vector and factors must be the same lengths")
