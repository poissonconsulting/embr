test_that(
  "model pars for smbr2 and cmdstan engine",
  {
    ...
    # MCMC trajectories diverge across R/rstan/Boost combos; snapshots stay
    # locked to one platform. Skip on R-devel where the toolchain drifts
    # ahead of the recorded values.
    skip_if(
