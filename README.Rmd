...
`mb_analysis` - 1 analysis
`mb_analyses` - 2 or more analyses on the same data
`mb_meta_analysis` - 2 or more analyses with the same model on different data
`mb_meta_analyses` - 2 or more `mb_analyses` (on different data)
